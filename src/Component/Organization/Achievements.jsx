...
const certificateDescriptions = [
    ...
    "MKJB Career Exhibition (2013)", // New
  
    "IBTE School of Energy and Engineering Satellite Market Day 2018", // New
    "IBTE Sultan Bolkiah Campus Market Day 2019", // New
 
    "IBTE Central Market Day", // New
 
    "Pesta Kerjaya 2022", // New
    "Recruitment Fair 2022", // New
    "Pesta Convo IBTE 2023", // New
  ];
          ...
          {certificates.slice(4).map((certificate, index) => (
            ...
            >
              ...
              <div className="text-center mt-4">
                <p>{certificateDescriptions[index]}</p> {/* Customize text if necessary */}
              </div>
            </div>
          ))}
        </div>
