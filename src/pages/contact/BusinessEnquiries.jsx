    ...
    <div className="screen-size flex flex-col items-center justify-center sm:px-10">
      ...
      <div className='border border-[#E2D82D] center flex-col p-2 lg:p-12 sm:p-5'>
        ...
        <div className='flex flex-col lg:flex-row gap-6 mb-6'>
          <div className='w-[411px] h-[100px] bg-white p-6 rounded-lg flex items-center'>
          ...
          <div className='w-[411px] h-[100px] bg-white p-6 rounded-lg flex items-center'>
            ...
            <p className="ml-4">673 3334543 / 3342047</p>
          </div>
          <div className='w-[411px] h-[100px] bg-white p-6 rounded-lg  flex items-center'>
            <span role="img" aria-label="Email" className="text-dark_red text-[30px]"><FaMessage /></span>
            <p className="ml-4">enquiries@adininworks.com</p>
          </div>
        </div>
          ...
          <div className='w-[411px] h-[267px] bg-white p-6 rounded-lg shadow-md'>
            ...
            <div className="max-sm:mt-5 mt-2">
              <p className='mt-5'><strong>(Sungai Bera-Workshop)</strong>
                Lot 55, 56, 57 & 63 Tapak Perindustrain Sungai Bera, Seria, Belait District, Brunei Darussalam.
              </p>
            </div>
          </div>
