...
export const HomeMS = () => {
  return (
    <div 
      className=" screen-size center flex-col mb-20"
    >
     ...
     {services.map((service, index) => (
        <div 
          key={index} 
          className="w-full sm:max-w-[270px] h-[250px] bg-cover homeMs-bg bg-center shadow-md rounded-lg p-6  flex-col center text-center "
        >
