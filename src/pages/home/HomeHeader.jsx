...
<div className="screen-size m-0">
    <div className="flex overflow-hidden  justify-start items-start ml-20 ">
...
<div className="bg-yellow border max-sm:w-full p-6 rounded-l-2xl w-1/2 h-[180px] mx-auto flex justify-between items-center absolute -bottom-24 right-0 max-sm:left-0">
      <div className="flex items-center space-x-5">
        <span className="text-black text-2xl border p-2 rounded-full"><FaLocationDot/></span>
        <div>
      ...
      <div className="flex items-center space-x-5">
        <span className="text-black text-2xl border p-2 rounded-full"><MdCall/></span>
        <div>
