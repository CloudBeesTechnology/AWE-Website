...
export const HisMajesty77 = ({ images = [], onClick }) => {
  ...
  return (
    <section className="p-2 center flex-col" onClick={onClick} style={{ cursor: 'pointer' }}>
      ...
      <div className='border rounded-md border-[#F464C4] max-w-lg w-full max-h-[275px] h-full overflow-hidden'>
        <div className='p-2 rounded-md border-t-4 border-[#F148E5] flex justify-center items-center h-full'>
          {imageSrc && (
            <img
              src={imageSrc}
