...
`;
export const createSDNDetails = /* GraphQL */ `
  mutation CreateSDNDetails(
    $input: CreateSDNDetailsInput!
    $condition: ModelSDNDetailsConditionInput
  ) {
    createSDNDetails(input: $input, condition: $condition) {
      id
      empID
      sawpEmpLtrReq
      sawpEmpLtrReci
...
`;
export const updateSDNDetails = /* GraphQL */ `
  mutation UpdateSDNDetails(
    $input: UpdateSDNDetailsInput!
    $condition: ModelSDNDetailsConditionInput
  ) {
    updateSDNDetails(input: $input, condition: $condition) {
      id
      empID
      sawpEmpLtrReq
      sawpEmpLtrReci
...
`;
export const deleteSDNDetails = /* GraphQL */ `
  mutation DeleteSDNDetails(
    $input: DeleteSDNDetailsInput!
    $condition: ModelSDNDetailsConditionInput
  ) {
    deleteSDNDetails(input: $input, condition: $condition) {
      id
      empID
      sawpEmpLtrReq
      sawpEmpLtrReci
