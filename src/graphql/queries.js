...
`;
export const getSDNDetails = /* GraphQL */ `
  query GetSDNDetails($id: ID!) {
    getSDNDetails(id: $id) {
      id
      empID
      sawpEmpLtrReq
...
`;
export const listSDNDetails = /* GraphQL */ `
  query ListSDNDetails(
    $filter: ModelSDNDetailsFilterInput
    $limit: Int
    $nextToken: String
  ) {
    listSDNDetails(filter: $filter, limit: $limit, nextToken: $nextToken) {
      items {
        id
        empID
        sawpEmpLtrReq
